    ...
    @section('page-title', 'Update Staff')
    ...
    <div class="page-header">
        <div>
            ...
            <div class="page-subtitle">Update Staff</div>
        </div>
                ...
                <div class="form-grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="text"
                            name="employee_id"
                            value="{{ old('$employeeId' , $staff->employee_id) }}"
                            readonly
                            required>
                    </div>
                ...
                <div class="form-grid-2">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" id="category" required>
                            ...
                            <option value="{{ $dept }}"
                        {{ old('category', $staff->category) == $dept ? 'selected' : '' }}>
                                {{ $dept }}
                            </option>
                ...
                <div class="form-grid-4">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('total_salary', $staff->salary) }}"
                            required
                            step="0.01"
                            min="0">
                    </div>
                ...
                <select id="salary_year" name="salary_year">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="{{ old('other_allowance', $staff->other_allowance) }}"
                            step="0.01">
                    </div>
    ...
    <select name="site_id" id="site_id" required>
        ...
        @foreach($sites as $site)
            <option value="{{ $site->id }}"
                {{ old('site_id', $staff->site_id) == $site->id ? 'selected' : '' }}>
                {{ $site->name }}
            </option>
        @endforeach
        </select>
                ...
                <div class="form-grid-2">
                    ...
                    <div class="form-grid-2">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('Nominee_details', $staff->Nominee_details) }}"
                                ...
                                <select name="relation" id="nominee_relation">
                                    ...
                                    @foreach($relations as $relation)
                                        <option value="{{ $relation }}"
                                            {{ old('relation', $staff->relation) == $relation ? 'selected' : '' }}>
                                            {{ $relation }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="text"
                            name="Pan_Card"
                            value="{{ old('Pan_Card'. $staff->Pan_Card) }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="text"
                            name="ESIC_Number"
                            value="{{ old('ESIC_Number', $staff->ESIC_Number) }}">
                    </div>
