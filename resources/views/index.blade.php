...
<div class="card">
    ...
    <div class="card-body" style="display:flex;gap:10px;flex-wrap:wrap;">
        {{-- <a href="{{ route('admin.labours.create') }}" class="btn btn-primary"><i class="fas fa-user-plus"></i> Add Labour</a>
        <a href="{{ route('admin.attendance.index') }}" class="btn btn-success"><i class="fas fa-calendar-check"></i> Mark Attendance</a>
        <a href="{{ route('admin.salary.index') }}" class="btn btn-secondary"><i class="fas fa-file-invoice-dollar"></i> Salary Slips</a>
        <a href="{{ route('admin.attendance.monthly') }}" class="btn btn-outline"><i class="fas fa-calendar-alt"></i> Monthly Report</a>
