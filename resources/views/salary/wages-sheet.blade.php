        ...
        <table class="wages-table">
            ...
            <tbody>
                ...
                @php
                    ...
                    $totalActualBasic += $salary->labour->basic_salary ?? 0;
                    $totalActualHra += $salary->labour->hra ?? 0;
                    $totalActualAllowance += $salary->labour->other_allowance ?? 0;
                ...
                <tr>
                    ...
                    {{-- Actual --}}
                    <td>{{ number_format($salary->labour->basic_salary ?? 0,0) }}</td>

                    <td>{{ number_format($salary->labour->hra ?? 0,0) }}</td>

                    <td>{{ number_format($salary->labour->other_allowance ?? 0,0) }}</td>
